...
<title>Error</title>
<body>
  <style>@import url('https://fonts.googleapis.com/css2?family=Permanent+Marker&family=Fira+Mono:wght@500&display=swap');
body{
    height: 95vh;
    background: #000000;
    text-align: center;
...
a{
    ...
    <div class="text">
      ...
      <h2>Couldn't launch :(</h2>
         <h3>Something went wrong - lets take you <a href="http://itclub.000.pe">BACK</a></h3> 
    </div>
</body>