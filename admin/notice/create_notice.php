...
<body>
  ...
  <br/>
    <h2 class="text-center fw-bold my-2 mt-1">Create Notice
    <?php
if($admin_level < 3){
...
?>
  ...
  <div class="container">
    <form method="post" enctype="multipart/form-data" id="noticeForm">
        ...
        <input type="file" name="notice_image" class="mb-3 thumbnail" accept="image/*">
  ...
  <div class="progress-bar uploadStatus" role="progressbar" style="width: 0;">0%</div>
      ...
      <div class="text-center">
        <input type="button" value="Create Notice" class="btn btn-primary createNotice">
      </div>
    </form>
    </div>
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="components/create_notice.js"></script>
