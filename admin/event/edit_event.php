...
<body>
  ...
  <br/>
    <h2 class="text-center fw-bold my-2">Edit Event
    <?php
if($admin_level < 3){
  echo "<p style='color:red;font-size:16px;'>You are currently not allowed to edit events.</p>";
}
?>
    </h2>
  <div class="container">
    <form method="post" enctype="multipart/form-data" id="eventForm">
        ...
        <input type="file" name="event_image" class="mb-3 thumbnail" id="thumbnail" accept="image/*">
  ...
  <div class="progress-bar uploadStatus" role="progressbar" style="width: 0;">0%</div>
      ...
      <div class="text-center">
        <input type="button" value="Update Event" class="btn btn-primary updateEvent">
      </div>
    </form>
    </div>
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="components/edit_event.js"></script>
