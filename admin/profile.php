  ...
  <section class="container">
    <form class="profile-form d-flex flex-column align-items-center" method="post" action="" enctype="multipart/form-data">
      <div class="profile-img position-relative rounded-circle mt-4" style="width:120px;height:120px">
        <label for="profilepic"><img src="images/admins/<?php echo $admin_profilepic;?>" alt="<?php echo $admin_name;?>" class="rounded-circle profilepic-prev" style="width:100%;height:100%"></label>
        ...
        <label for="profilepic" class="text-center profilepic-note" style="margin-top:5px;color:red;font-size:13px;">Upload square image for better view (Max size 1 MB)</label>
      ...
      <div class="mt-2 d-flex justify-content-center" style="width:100%;">
        <button type="button" name="update" id="update" class="btn btn-success update">Update Details</button>
        <button type="button" id="edit" class="edit btn btn-primary">Edit Details</button>
      </div>
    </form>
    <hr>
