...
<p style="text-align:center;color:red;">Note: If you want to sent email to subscribers then set visibility either to public or scheduled otherwise blog email notification will not be sent.</p>
