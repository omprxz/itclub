    ...
    <div class="auth">
        <form action="authenticate.php" method="post" class="login">
            <h2>ADMIN LOG IN</h2>
                ...
                <a href="reset.php" style="color:yellow;text-decoration:none;margin:20px auto;"> Forgot your password? Reset Here </a>
                <a href="signup.php" style="color:yellow;text-decoration:none;margin:20px auto;"> Create new account </a>
        </form>
